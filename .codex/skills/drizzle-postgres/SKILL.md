...
This is a community-maintained skill vendored from `honra-io/drizzle-best-practices`, not an official Drizzle ORM project skill. Use https://orm.drizzle.team/docs as the authority when guidance conflicts.
