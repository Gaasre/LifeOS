...
This is a community-maintained skill vendored from `secondsky/claude-skills`, not an official Hono project skill. Use https://hono.dev/docs as the authority when guidance conflicts.
